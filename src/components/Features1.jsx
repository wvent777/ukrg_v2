          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
              ...
              <p className="mb-10 text-customGrayText leading-loose">
                The mission of Ukpasia Realty is to provide an outstanding level
                of service and expertise in the real estate market. Ukpasia
                Realty wants to provide excellence in real estate services to
                all of our customers and clients by conducting all of our
                business with the highest levels of professionalism, honesty and
                integrity. Let us help you sell your property for top dollar.
              </p>
